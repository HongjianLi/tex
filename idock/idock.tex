...
\IEEEauthorblockN
{
Hongjian Li\IEEEauthorrefmark{1}, Kwong-Sak Leung\IEEEauthorrefmark{1} and Man-Hon Wong\IEEEauthorrefmark{1}
\IEEEauthorblockA
{
\IEEEauthorrefmark{1}
...
As the X-ray crystallography technology evolves, more and more structures of biological macromolecules at atomic level have been revealed and deposited into the world's largest repository Protein Data Bank (PDB) \cite{539-2000,537-2003}. This rapid evolution catalyzes the development of various protein-ligand docking tools for structure-based drug discovery.
...
Among the many docking programs, AutoDock Vina \cite{595-2010} (hereafter Vina for short) is a competitive one. It is free and open source. It runs faster than its predecessor AutoDock4 \cite{596-2009} by an order of magnitude \cite{556-2010}. First released in 2010, Vina has been cited by over 200 publications according to Google Scholar and adopted by quite many researchers \cite{609-2010}, demonstrating its popularity.
...
\bottomrule
\end{tabular}
\caption{Tanimoto coefficients between TDF and the inhibitors of HIV RT, SAHH, ADA, and PNP using the Scitegic ECFP4 and Daylight fingerprints through the SEA database \cite{380-2007}.}
...
% as detailed in equation \eqref{eqn:grid_e}
%\begin{eqnarray}
%\label{eqn:grid_e}
%e_{inter} &=& e_{inter,000} * (1-\alpha_x) * (1-\alpha_y) * (1-\alpha_z) \nonumber \\
%          &+& e_{inter,100} *    \alpha_x  * (1-\alpha_y) * (1-\alpha_z) \nonumber \\
%          &+& e_{inter,010} * (1-\alpha_x) *    \alpha_y  * (1-\alpha_z) \nonumber \\
%          &+& e_{inter,110} *    \alpha_x  *    \alpha_y  * (1-\alpha_z) \nonumber \\
%          &+& e_{inter,001} * (1-\alpha_x) * (1-\alpha_y) *    \alpha_z  \nonumber \\
%          &+& e_{inter,101} *    \alpha_x  * (1-\alpha_y) *    \alpha_z  \nonumber \\
%          &+& e_{inter,011} * (1-\alpha_x) *    \alpha_y  *    \alpha_z  \nonumber \\
%          &+& e_{inter,111} *    \alpha_x  *    \alpha_y  *    \alpha_z
%\end{eqnarray}
...
The crystal structures of HIV RT, SAHH, ADA, and PNP were collected from the Protein Data Bank (PDB) database \cite{539-2000,537-2003}. Protein-ligand complexes with PDB IDs of 2ZD1, 1LI4, 3IAR, and 3BGS were selected because they were crystallized at high resolutions (Table \ref{tab:SelectedPDBEntries}). Search spaces were then manually defined in cuboid shape to be large enough for ligands to freely translate and rotate inside.
...
10,928 ligands were collected from the clean drug like subset of the ZINC database \cite{532-2005}. These ligands satisfy Lipinski's \textit{Rule of Five} \cite{169-1997} with the xLogP value of at most 5, the molecular weight between 150 Da and 500 Da, the number of hydrogen bond donors of at most 5, and the number of hydrogen bonds acceptors of at most 10.
...
\begin{figure}
\centering
\subfigure[HIV RT in complex with crystal and docked T27.]
{
  \includegraphics[width=0.46\linewidth]{Figures/2ZD1-T27.png}
  \label{subfig:2ZD1-T27}
}
\subfigure[SAHH in complex with crystal and docked NAD.]
{
  \includegraphics[width=0.46\linewidth]{Figures/1LI4-NAD.png}
  \label{subfig:1LI4-NAD}
}
\subfigure[ADA in complex with crystal and docked 3D1.]
{
  \includegraphics[width=0.46\linewidth]{Figures/3IAR-3D1.png}
  \label{subfig:3IAR-3D1}
}
\subfigure[PNP in complex with crystal and docked DIH.]
{
  \includegraphics[width=0.46\linewidth]{Figures/3BGS-DIH.png}
...
{
  \includegraphics[width=0.46\linewidth]{Figures/2ZD1-ZINC19888543.png}
  \label{subfig:2ZD1-ZINC19888543}
}
\subfigure[SAHH in complex with ZINC19888543.]
{
  \includegraphics[width=0.46\linewidth]{Figures/1LI4-ZINC19888543.png}
  \label{subfig:1LI4-ZINC19888543}
}
\subfigure[ADA in complex with ZINC19888543.]
{
  \includegraphics[width=0.46\linewidth]{Figures/3IAR-ZINC19888543.png}
  \label{subfig:3IAR-ZINC19888543}
}
\subfigure[PNP in complex with ZINC19888543.]
{
  \includegraphics[width=0.46\linewidth]{Figures/3BGS-ZINC19888543.png}
...
{
  \includegraphics[width=0.46\linewidth]{Figures/2ZD1-ZINC44392991.png}
  \label{subfig:2ZD1-ZINC44392991}
}
\subfigure[SAHH in complex with ZINC44392991.]
{
  \includegraphics[width=0.46\linewidth]{Figures/1LI4-ZINC44392991.png}
  \label{subfig:1LI4-ZINC44392991}
}
\subfigure[ADA in complex with ZINC44392991.]
{
  \includegraphics[width=0.46\linewidth]{Figures/3IAR-ZINC44392991.png}
  \label{subfig:3IAR-ZINC44392991}
}
\subfigure[PNP in complex with ZINC44392991.]
{
  \includegraphics[width=0.46\linewidth]{Figures/3BGS-ZINC44392991.png}
