...
In some types of graphs, edges may bear different types for different kinds of relationships. \Citeauthor{1052} propose a class of reachability queries in which an edge is specified with a regular expression of a certain form, expressing the connectivity in a data graph via edges of various types, and develop an algorithm for answering reachability queries in quadratic time. \citep{1052}
