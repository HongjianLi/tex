...
Although we only used RF in this study, we believe our conclusions are also applicable to SVR (support vector regression)-based scoring functions \cite{1295,963} as well as other machine-learning scoring functions. % TODO: the correction achieved by other machine learning algorithms could be higher, but here only a proof-of-concept.
...
\caption{\csentence{Correlation plots of measured and predicted binding affinites by the four models trained on crystal poses and tested on docked poses of the PDBbind v2013 blind benchmark.} Model 1 is AutoDock Vina. Model 2 is MLR::Vina. Model 3 is RF::Vina. Model 4 is RF::VinaElem.}
...
\caption{\csentence{Correlation plots of measured and predicted binding affinites by the four models trained on docked poses and tested on docked poses of the PDBbind v2013 blind benchmark.} Model 1 is AutoDock Vina. Model 2 is MLR::Vina. Model 3 is RF::Vina. Model 4 is RF::VinaElem.}
