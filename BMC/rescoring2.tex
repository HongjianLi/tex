...
where $N_a$ is the number of heavy atoms, $(x_c^{(n)}, y_c^{(n)}, z_c^{(n)})$ is the 3D coordinate of the $n$th heavy atom of the crystal pose, and $(x_d^{(n)}, y_d^{(n)}, z_d^{(n)})$ is the 3D coordinate of the $n$th heavy atom of the docked pose.
...
\caption{\csentence{Performance of the four models trained on crystal and docked poses and tested on crystal and docked poses of the PDBbind v2007 benchmark.}}
...
\caption{\csentence{Performance of the four models trained on crystal and docked poses and tested on crystal and docked poses of the PDBbind v2013 blind benchmark.}}
...
\caption{\csentence{Correlation plots of the four models trained on crystal poses and tested on docked poses of the PDBbind v2013 blind benchmark.}}
...
\caption{\csentence{Correlation plots of the four models trained on docked poses and tested on docked poses of the PDBbind v2013 blind benchmark.}}
