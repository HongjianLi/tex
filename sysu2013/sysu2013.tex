...
\title{istar: A Web Platform for Large-Scale Protein-Ligand Docking} % can use linebreaks \\ within to get better formatting as desired
\author
{
\IEEEauthorblockN
{
Hongjian Li\IEEEauthorrefmark{1}, Kwong-Sak Leung\IEEEauthorrefmark{1}, Pedro J. Ballester\IEEEauthorrefmark{2}, and Man-Hon Wong\IEEEauthorrefmark{1}
\IEEEauthorblockA
{
\IEEEauthorrefmark{1}
...
bioinformatics, chemoinformatics, computer-aided drug discovery, molecular docking
...
\begin{equation}
\label{eqn5}
Consensus = 0.5 \times (-0.73349480509 \cdot idockScore + RFScore)
\end{equation}
...
\begin{figure}
\begin{center}
\includegraphics[width=\linewidth]{Slider.png}
\end{center}
\caption{
istar supports filtering ligands with molecular properties in a fine-grained manner and previewing the number of ligands to dock in real time. Users can move the nine sliders to filter ligands in the form of closed intervals.
}
\label{Slider}
\end{figure}
...
\end{center}
\caption{
istar supports monitoring job progress in real time. Users can thus have a rough estimation in advance of how long the jobs will take and when the jobs will complete.
}
\label{Progress}
\end{figure}
...
\begin{table}
\caption{
Comparison of 21 scoring functions on PDBbind v2007 core set ($N$ = 195)}
\begin{tabular}{lrrr}
\hline
...
\begin{figure}
\begin{center}
\includegraphics[width=\linewidth]{PDBbind2012Correlations.eps}
\end{center}
\caption{
...
\begin{figure}
\begin{center}
\includegraphics[width=\linewidth]{CSAR2010Correlations.eps}
\end{center}
\caption{
...
\begin{figure}
\begin{center}
\includegraphics[width=\linewidth]{Redocking4TMN.png}
\end{center}
\caption{
Redocking result of PDB ID 4TMN. The protein target is thermolysin. $RMSD$ = 8.40\AA\ for Vina, and $RMSD$ = 9.91\AA\ for idock. Both methods failed to predict a conformation sufficiently close to that of the co-crystallized ligand, probably due to the presence of a zinc ion in the binding site.
}
\label{Redocking4TMN}
\end{figure}
...
\begin{figure}
\begin{center}
\includegraphics[width=\linewidth]{Redocking1PKX.png}
\end{center}
\caption{
Redocking result of PDB ID 1PKX. The protein target is bifunctional purine biosynthesis protein PURH. $RMSD$ = 7.06\AA\ for Vina, and $RMSD$ = 0.21\AA\ for idock. idock managed to predict a conformation sufficiently close to that of the co-crystallized ligand but AutoDock Vina failed.
}
\label{Redocking1PKX}
\end{figure}
...
\begin{figure}
\begin{center}
\includegraphics[width=\linewidth]{Redocking3HV8.png}
\end{center}
\caption{
Redocking result of PDB ID 3HV8. The protein target is FimX. $RMSD$ = 0.29\AA\ for Vina, and $RMSD$ = 10.23\AA\ for idock. AutoDock Vina managed to predict a conformation sufficiently close to that of the co-crystallized ligand but idock failed.
}
\label{Redocking3HV8}
\end{figure}
...
\begin{table}
\caption{
Redocking success rates}
\begin{tabular}{lrrrrrr}
\hline
& \multicolumn{2}{c}{PDBbind v2012} & \multicolumn{2}{c}{PDBbind v2011} & \multicolumn{2}{c}{CSAR 2010}\\
...
\begin{figure}
\begin{center}
\includegraphics[width=\linewidth]{pK-idockConf1idock.eps}
\end{center}
\caption{
Scatter plot of the lowest idock score of the 9 docked conformations output by idock against the experimental binding affinity on PDBbind v2012 core set ($N$ = 201). Values are in $pK_d$ or $pK_i$ unit. $R_p$ = 0.502, $R_s$ = 0.530, $RMSE$ = 1.31, $SD$ = 1.32.
}
...
\begin{figure}
\begin{center}
\includegraphics[width=\linewidth]{pK-idockConfsRFScoreMax.eps}
\end{center}
\caption{
Scatter plot of the highest RF-Score of the 9 docked conformations output by idock against the experimental binding affinity on PDBbind v2012 core set ($N$ = 201). Values are in $pK_d$ or $pK_i$ unit. $R_p$ = 0.815, $R_s$ = 0.817, $RMSE$ = 0.75, $SD$ = 0.76.
}
...
\begin{figure}
\begin{center}
\includegraphics[width=\linewidth]{pK-idockConf1RFScore.eps}
\end{center}
\caption{
Scatter plot of the RF-Score of the first docked conformation against the experimental binding affinity on PDBbind v2012 core set ($N$ = 201). Values are in $pK_d$ or $pK_i$ unit. $R_p$ = 0.855, $R_s$ = 0.859, $RMSE$ = 0.73, $SD$ = 0.73.
}
