...
The query ligand is opened and visualized locally. Only the USR features are transferred over network. The feature vector alone is not sufficient to recover the original query ligand, so confidentiality is ensured.
