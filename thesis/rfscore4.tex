...
We reused the PDBbind v2013 blind benchmark because the four models have been evaluated on it in the previous chapter, allowing a direct comparison. Briefly, the test set comprises 382 complexes newly added in the 2013 release, whereas the four training sets comprise 792, 1300, 2057 and 2897 complexes from PDBbind v2002, v2007, v2010 and v2012 refined sets, respectively. Note that in the v2010 refined set, the 2rio protein contains Sr atoms and the 2ov4 protein contains Cs atoms, which cannot be recognized by Vina. Therefore this training set has N=2059-2=2057 complexes.%whereas the training set comprises 2897 complexes from PDBbind v2012 refined set.
