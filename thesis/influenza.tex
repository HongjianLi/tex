...
%Influenza NP is the most abundantly expressed protein during the course of infection.
...
% Interacting residues, important residues
...
\citep{1575} Identification of a PA-Binding Peptide with Inhibitory Activity against Influenza A and B Virus Replication.%Oct 2009
...
\citep{1576} Structure-based discovery of anti-influenza virus A compounds among medicines.%Feb 2012
...
There are two FDA approved medications that in addition to their intended use also possess anti-IAV abilities due to their structural similarity with the N terminal domain of PB1 that interacts with the C-terminus of PA (Figure 3) \citep{1576}.

\subsection{Polymerase basic protein 2 (PB2)}

\citep{1192} The structural basis for cap binding by influenza virus polymerase subunit PB2. two aromatic amino acids at positions 363 and 404 are necessary for cap-binding.%2008
