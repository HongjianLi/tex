\chapter{iview: protein-ligand visualization}
...
\end{center}
\caption{iview rendering of the CCR5 chemokine receptor-HIV entry inhibitor maraviroc complex, with default settings.}
\label{iview:ribbon}
\end{figure}
