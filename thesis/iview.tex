...
\begin{figure}[h!]
\caption{iview rendering of the CCR5 chemokine receptor-HIV entry inhibitor maraviroc complex \citep{1348} (PDB code: 4MBS). The secondary structure of human CCR5 is rendered as ribbon. The marketed HIV drug maraviroc is rendered as sphere. This figure can be reproduced at http://istar.cse.cuhk.edu.hk/iview/?4MBS}
\label{fig:ribbon}
\end{figure}
...
iview is free and open source under Apache License 2.0. It is written in JavaScript, HTML5 and CSS3. It is independent of operating systems but requires a browser and a graphics card with WebGL capability. A live demo is available at http://istar.cse.cuhk.edu.hk/iview.

\section{Future Works}

Both BINANA \citep{1413} and GIANT \citep{1359} characterize protein-ligand interaction patterns. Integrating them will make iview even more pragmatic.
