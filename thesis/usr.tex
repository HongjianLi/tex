...
The length of the feature vector is proportional to the number of frames.
...
Apart from the circumvention of conformer generation, another application of USRT is to detect ligand duplication, which is seen in \textit{de novo} fragment-based drug design tools such as our iSyn \citep{1409,1387}.
