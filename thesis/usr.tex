...
USR \citep{1379,1280} was developed. USR is independent of position and orientation, but is dependent on torsions. Much faster, USR finds its applications in retrospective \citep{1332} and prospective \citep{1380} virtual screening. USR was used for deduplication in a virtual screening experiment \citep{1390} and our iSyn \citep{1381,1387} de novo ligand deisgn software. % \citep{1332} study the ability of USR as a stand-alone method to identify molecules sharing common biological activities through retrospective virtual screening experiments.
