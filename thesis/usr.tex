...
USRCAT requires classification of atoms according to five predefined pharmacophoric subsets. Same query ligand in different formats, e.g. mol2, sdf, pdbqt, yields different classification results. We used ZINC00537755 as an example.
