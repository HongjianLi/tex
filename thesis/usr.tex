...
We selected 19 query ligands with different number of heavy atoms, spanning from 4 to 65. Table \ref{usr:Queries}. 82\% (=137/167).

\begin{table}
\caption{Molecular properties of the 19 query ligands. HA: heavy atoms. MWT: molecular weight in Daltons. HBD: hydrogen bond donors. HBA: hydrogen bond acceptors. NRB: rotatable bonds.}
\label{usr:Queries}
