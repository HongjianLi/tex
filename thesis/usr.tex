...
The success rate seemed to correlate with NRB. Table \ref{usr:RecoveryRate}.
...
Figure \ref{usr:ZINC96006018}

\begin{figure}
\centering
\subfloat[Query]
{
  \includegraphics[width=0.33\linewidth]{../usr/1GZ8/96006018/input/ZINC96006018.png}
}
\subfloat[USR rank 1.]
{
  \includegraphics[width=0.33\linewidth]{../usr/1GZ8/96006018/output-usr/ZINC40200504.png}
}
\subfloat[USR rank 2.]
{
  \includegraphics[width=0.33\linewidth]{../usr/1GZ8/96006018/output-usr/ZINC35402146.png}
}
\\
\subfloat[USR rank 3.]
{
  \includegraphics[width=0.33\linewidth]{../usr/1GZ8/96006018/output-usr/ZINC10462892.png}
}
\subfloat[USR rank 4.]
{
  \includegraphics[width=0.33\linewidth]{../usr/1GZ8/96006018/output-usr/ZINC09693915.png}
}
\subfloat[USR rank 5.]
{
  \includegraphics[width=0.33\linewidth]{../usr/1GZ8/96006018/output-usr/ZINC40206470.png}
}
\\
\subfloat[Query]
{
...
{
  \includegraphics[width=0.33\linewidth]{../usr/1GZ8/96006018/output-usrcat/ZINC77320087.png}
}
\subfloat[USRCAT rank 2.]
{
  \includegraphics[width=0.33\linewidth]{../usr/1GZ8/96006018/output-usrcat/ZINC31392738.png}
}
\\
\subfloat[USRCAT rank 3.]
{
  \includegraphics[width=0.33\linewidth]{../usr/1GZ8/96006018/output-usrcat/ZINC04536260.png}
}
\subfloat[USRCAT rank 4.]
{
  \includegraphics[width=0.33\linewidth]{../usr/1GZ8/96006018/output-usrcat/ZINC89960170.png}
}
\subfloat[USRCAT rank 5.]
{
  \includegraphics[width=0.33\linewidth]{../usr/1GZ8/96006018/output-usrcat/ZINC66730926.png}
}
\caption{Top 5 matching compounds for ZINC96006018 (a \& g) using USR (b to f) and USRCAT (h to l).}
\label{usr:ZINC96006018}
\end{figure}
...
memory allocation 5s (could be more if from swap), $8B*60*23M=10GB$ hard disk reading cost 149s.
82\% (=137/167).
...
\begin{tabular}{cccc}
\hline
ZINC ID  & \textit{ad hoc} (s) & in advance (s) & difference (s)\\
\hline
06827693 & 171 & 34 & 137\\
03641271 & 165 & 20 & 145\\
00000882 & 172 & 29 & 143\\
