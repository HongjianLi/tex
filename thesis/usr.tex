...
\begin{equation}
m_2=\sqrt[2]{\frac{1}{n}\sum_{i=1}^{n}{d_i-m_1}}
\label{usr:moment2}
\end{equation}

\begin{equation}
m_3=\sqrt[3]{\frac{1}{n}\sum_{i=1}^{n}{d_i-m_1}}
\label{usr:moment3}
\end{equation}
