...
\begin{figure}
\centering
\subfloat[$RMSD_1$ success rate.]
{
  \includegraphics[width=0.48\linewidth]{../istar/RMSD1SuccessRate.pdf}
}
\subfloat[$RMSD_{min}$ success rate.]
{
  \includegraphics[width=0.48\linewidth]{../istar/RMSDmSuccessRate.pdf}
}
\\
\subfloat[$RMSD_{min}$ conformation distribution.]
{
  \includegraphics[width=\linewidth]{../istar/RMSDmDistribution.pdf}
}
\caption{Redocking success rates of idock and AutoDock Vina.}
\label{istar:RedockingSuccessRateFigures}
\end{figure}
...
According to Google Analytics, throughout 2014, istar had served 460 sessions, 271 users, and 631 pageviews from 33 countries on 6 continents, except Antarctica merely. According to our internal statistics, from October 2013 to October 2014, there had been 635 job submissions with 46,581,105 ligands docked. These jobs came from 126 email addresses, 64 of which were associated with multiple jobs while the other 62 were associated with one single job. In the future, we may ask users to fill in some forms of questionaire in order to systematically collect comments and feedback, as well as their successful drug discovery endeavors using istar.
