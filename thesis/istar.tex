...
\begin{figure}
\centering
\subfloat[Redocking result of PDB 1B8N.]
{
  \includegraphics[width=0.32\linewidth]{../istar/Redocking1B8N.png}
}
\subfloat[Redocking result of PDB 4TMN.]
{
  \includegraphics[width=0.32\linewidth]{../istar/Redocking4TMN.png}
}
\\
\subfloat[Redocking result of PDB 1PKX.]
{
  \includegraphics[width=0.32\linewidth]{../istar/Redocking1PKX.png}
}
\subfloat[Redocking result of PDB 3HV8.]
{
  \includegraphics[width=0.32\linewidth]{../istar/Redocking3HV8.png}
}
