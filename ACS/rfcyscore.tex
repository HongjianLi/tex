...
This section introduces three scoring functions building upon Autodock Vina, two benchmarks to evaluate performance of these scoring functions and the performance metrics that will be used to this end.
