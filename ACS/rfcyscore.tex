...
The test set comprises the complexes in. This led to a total of 592 complexes, whose experimental binding affinities span 9.80 pKd units. The test set size is significantly larger than that of the v2007 or v2012 benchmarks. By construction, there are no complexes in common between the test set and any of the four training sets.
