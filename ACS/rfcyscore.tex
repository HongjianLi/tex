...
Cyscore is a classical empirical scoring function in an additive functional form of four terms (Eq. \ref{eqn:cyscore}), whose coefficients $k_h$, $k_v$, $k_b$ and $k_e$ were obtained by MLR on 247 high-quality complexes carefully selected from PDBbind v2012 refined set%, which is hereafter denoted as \textit{trn247} in this study for convenience.
...
We propose a new training set: refined13-core07-core12. N=2280. By construction, the overlaps between training and test sets = 0.% |trn2280 U tst201| = 28.
