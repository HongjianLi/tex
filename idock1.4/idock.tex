...
\begin{figure*}
\centering
\subfloat[Distribution of molecular weight of set 1.]
{
  \label{200-300MWT}
  \includegraphics[width=0.41\linewidth]{200-300MWT.pdf}
}
\subfloat[Distribution of number of rotatable bonds of set 1.]
{
  \label{200-300NRB}
  \includegraphics[width=0.41\linewidth]{200-300NRB.pdf}
}
\\
\subfloat[Distribution of molecular weight of set 2.]
{
  \label{300-400MWT}
  \includegraphics[width=0.41\linewidth]{300-400MWT.pdf}
}
\subfloat[Distribution of number of rotatable bonds of set 2.]
{
  \label{300-400NRB}
  \includegraphics[width=0.41\linewidth]{300-400NRB.pdf}
}
\\
\subfloat[Distribution of molecular weight of set 3.]
{
  \label{400-500MWT}
  \includegraphics[width=0.41\linewidth]{400-500MWT.pdf}
}
\subfloat[Distribution of number of rotatable bonds of set 3.]
{
  \label{400-500NRB}
  \includegraphics[width=0.41\linewidth]{400-500NRB.pdf}
}
