...
%Molecular structure input on the web \citep{1243}
%EvolView, an online tool for visualizing, annotating and managing phylogenetic trees \citep{1241}
%ePlant and the 3D Data Display Initiative: Integrative Systems Biology on the World Wide Web \citep{1242}
%VLPC: A HTML5 pharmacology virtual laboratory \citep{1249}
