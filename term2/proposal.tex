...
The existing scoring function shall be revised, properly merging individual scores into an overall one. The existing search algorithm shall also be revised to avoid possible steric clashes.
