...
\begin{figure}
\centering
\includegraphics[width=\textwidth]{igrow/MutationComplex.png}
\caption{Synthesized elitists by mutation in complex with their target protein.}
\label{igrow:MutationComplex}
\end{figure}
