...
Protein-ligand docking is an essential part of computer-aided drug discovery. It tries to find inhibitors of viral proteins. Take the HIV virus for example (Figure ). The virus comprises several protein enzymes, which play an important role in replication. The reverse transcriptase reversely transcribes viral RNA into viral DNA. The integrase integres viral DNA into the normal human DNA in infected cells. The protease assemblies viral components into a new virus. If the viral proteins are inhibited, the replication cycle will be blocked. The inhibitors are typically small compounds called ligands.
