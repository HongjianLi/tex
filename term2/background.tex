...
Two early stages of the modern drug discovery pipeline are lead identification and lead optimization. From the computational perspective, the former can be addressed by virtual screening while the latter can be addressed by computational ligand synthesis.
...
\section{Computational Ligand Synthesis}

Virtual screening tries to discover promising ligands out of a database. Apparently the diversity of its outcome is limited to the diversity of the database. In other words, if the database contains no promising ligands at all, virtual screening will fail.
