...
%What makes a good drug target \citep{1032}

\section{Protein-Ligand Docking}

%docking programs
%Survey \citep{454,493}
%Comparison \citep{452,637}
%Structure-based drug design review, with tools and databsaes \citep{922}
%Fleksy \citep{591}
%FITTED \citep{602}
%EADock \citep{606}
%FRED \citep{772}
...
%Systematic Exploitation of Multiple Receptor Conformations for Virtual Ligand Screening \citep{675}
...
%LISA \citep{775}
%NNScore 2.0 \citep{977}

%pgorams
%DOCK
%PLANTS \citep{610,607}
%QuickVina \citep{1193}
%CRDOCK \citep{1200}
...
%cases
%attractive therapeutic target in anticancer drug development \citep{456}, Protein kinase B \citep{502} carbonic anhydrase IX \citep{503}, GIIA secreted phospholipase A\textsubscript{2} \citep{506}, 
%HIV-1 Reverse Transcriptase \citep{843}
%Molecular Docking and Dynamics Simulation, Receptor-based Hypothesis: Application to Identify Novel Sirtuin 2 Inhibitors \citep{1177}
