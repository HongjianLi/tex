...
Table \ref{Introduction:Progress} summaries our major contributions and roughly estimates the current progress of our projects and case studies.
...
We have developed istar as a SaaS (Software as a Service) platform for running programs online, and ported idock and igrep onto istar, feating ligand filtering and previewing, progress monitoring in real time, innovative two-phase docking, slice-level parallelism, supplier list output, and GPU acceleration. & \\
