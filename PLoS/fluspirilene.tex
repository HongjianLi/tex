...
We further inspected the predicted conformation of fluspirilene in the presence of CDK2 molecular surface (\nameref{S7_Figure}). Compared with the guanine derivative MBP (\nameref{S8_Figure}), fluspirilene occupies a much larger portion of the binding pocket, and its shape properly matches that of the binding cavity. Given this structural analysis together with our \textit{in vitro} and \textit{in vivo} experiments, we infer that fluspirilene may physically bind to CDK2.
