...
Table S2. Ensemble docking results of the 4,914 compounds. The table comprises the ZINC ID, the average score and the individual scores for the 44 selected CDK2 structures, and the molecular properties.%log.csv

Table S3. Details of the nine top-scoring compounds purchased. The table comprises the ZINC ID, the average score, scientific name, clinical uses and references.%top.csv
