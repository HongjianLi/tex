...
Using innovative 3D techniques, we provide a user friendly visualizer that is not intended to compete with professional visualizers, but that instead enables easy accessibility and platform independence.
\end{abstract}
...
\section*{Conclusions}
We have designed iview to be a simple and straightforward way to visualize protein-ligand complex. It enables non-experts to quickly elucidate protein-ligand interactions in a 3D manner.
