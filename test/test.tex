...
\begin{figure*}
\centering
\includegraphics[width=\linewidth]{../nlcc/figures/l1_f50/t1T2/roc.eps}
\caption{set1.}
\label{fig:set1}
\end{figure*}
...
\subfloat[active.]
{
  ...
  \includegraphics[width=0.14\linewidth]{../nlcc/figures/l1_f50/set1/active.pdf}
}
\subfloat[gauss 1.]
{
  \label{subfig:l1_f50_set1_gauss1}
  \includegraphics[width=0.14\linewidth]{../nlcc/figures/l1_f50/set1/gauss1.pdf}
}
\subfloat[gauss 2.]
{
  \label{subfig:l1_f50_set1_gauss2}
  \includegraphics[width=0.14\linewidth]{../nlcc/figures/l1_f50/set1/gauss2.pdf}
}
\subfloat[repulsion.]
{
  \label{subfig:l1_f50_set1_repulsion}
  \includegraphics[width=0.14\linewidth]{../nlcc/figures/l1_f50/set1/repulsion.pdf}
}
\subfloat[hydrophobic interaction.]
{
  \label{subfig:l1_f50_set1_hydrophobic}
  \includegraphics[width=0.14\linewidth]{../nlcc/figures/l1_f50/set1/hydrophobic.pdf}
}
\subfloat[hydrogen bonding.]
{
  \label{subfig:l1_f50_set1_hydrogenbonding}
  \includegraphics[width=0.14\linewidth]{../nlcc/figures/l1_f50/set1/hydrogenbonding.pdf}
}
