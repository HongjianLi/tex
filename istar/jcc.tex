...
Here is the outline of the paper. We will first describe the five functional components of istar, followed by its novel features that are only available at istar and commonly unseen on other docking platforms. We will then present the key features of idock 2.0 compared to version 1.0. In the result section, we will detail the benchmarks of both redocking and virtual screening. In the end, we will give software availability and a discussion.
