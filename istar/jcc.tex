...
\begin{figure}
\begin{center}
\includegraphics[width=\linewidth,keepaspectratio=true]{Relationship.eps}
\caption{\label{relationship} The relationship between istar and idock.}
\end{center}
\end{figure}
...
\begin{figure}
\begin{center}
\includegraphics[width=\linewidth,keepaspectratio=true]{Architecture.eps}
\caption{\label{architecture} The istar architecture.}
\end{center}
\end{figure}
...
\begin{figure}
\begin{center}
\includegraphics[width=0.9\linewidth,keepaspectratio=true]{idock.eps}
\caption{\label{idock} The idock web site on istar, available at http://idock.cse.cuhk.edu.hk}
\end{center}
\end{figure}
...
\subfloat
{
  \includegraphics[width=0.315\linewidth]{mwt.eps}
}
\subfloat
{
  \includegraphics[width=0.315\linewidth]{logp.eps}
}
\subfloat
{
  \includegraphics[width=0.315\linewidth]{ad.eps}
}
\\
\subfloat
{
  \includegraphics[width=0.315\linewidth]{pd.eps}
}
\subfloat
{
  \includegraphics[width=0.315\linewidth]{hbd.eps}
}
\subfloat
{
  \includegraphics[width=0.315\linewidth]{hba.eps}
}
\\
\subfloat
{
  \includegraphics[width=0.315\linewidth]{tpsa.eps}
}
\subfloat
{
  \includegraphics[width=0.315\linewidth]{charge.eps}
}
\subfloat
{
  \includegraphics[width=0.315\linewidth]{nrb.eps}
}
\caption{\label{LigandProperties} Histogram distributions of 9 molecular properties of the 12,171,187 clean ligands.}
\end{figure}
\end{center}
...
\begin{figure}
\begin{center}
\includegraphics[width=\linewidth,keepaspectratio=true]{2PhaseDocking.eps}
\caption{\label{2PhaseDocking} Illustration of 2-phase docking.}
\end{center}
\end{figure}
...
{
  \includegraphics[width=\linewidth]{JobLevelParallelism.eps}
}
\\
\subfloat[Slice-level parallelism.]
{
  \includegraphics[width=\linewidth]{SliceLevelParallelism.eps}
}
\caption{\label{2LevelParallelism} Illustration of 2-level parallelism.}
\end{figure}
\end{center}
...
\begin{figure}
\begin{center}
\includegraphics[width=\linewidth,keepaspectratio=true]{OutputPDBQT.eps}
\caption{\label{OutputPDBQT} Verbose output of the idock daemon in PDBQT format.}
\end{center}
\end{figure}
...
\begin{figure}
\begin{center}
\includegraphics[width=\linewidth,keepaspectratio=true]{OutputCSV.eps}
\caption{\label{OutputCSV} Summary output of the idock daemon in CSV format.}
\end{center}
\end{figure}
...
\begin{figure}
\begin{center}
\includegraphics[width=\linewidth]{ThreadPool.eps}
...
\begin{figure}
\begin{center}
\includegraphics[width=\linewidth]{Compression.eps}
...
\begin{figure}
\begin{center}
\includegraphics[width=\linewidth]{ChemicalElements.eps}
...
{
  \includegraphics[width=0.485\linewidth]{Redocking1B8N.eps}
}
\subfloat[PDB ID 4TMN. Vina RMSD1 = 8.401 \AA. idock RMSD1 = 9.909 \AA.]
{
  \includegraphics[width=0.485\linewidth]{Redocking4TMN.eps}
}
\\
\subfloat[PDB ID 1PKX. Vina RMSD1 = 7.059 \AA. idock RMSD1 = 0.214 \AA.]
{
  \includegraphics[width=0.485\linewidth]{Redocking1PKX.eps}
}
\subfloat[PDB ID 3HV8. Vina RMSD1 = 0.290 \AA. idock RMSD1 = 10.232 \AA.]
{
  \includegraphics[width=0.485\linewidth]{Redocking3HV8.eps}
}
\caption{\label{Redocking} Redocking results of four cases.}
\end{figure}
\end{center}
...
{
  \includegraphics[width=0.31\linewidth]{PDBbind2012FECorrelation.eps}
}
\subfloat[PDBbind v2011 refined set]
{
  \includegraphics[width=0.31\linewidth]{PDBbind2011FECorrelation.eps}
}
\subfloat[CSAR NRC HiQ Set 24Sept2010]
{
  \includegraphics[width=0.31\linewidth]{CSARFECorrelation.eps}
}
...
\subfloat
{
  \includegraphics[width=0.485\linewidth]{MWT3.eps}
}
\subfloat
{
  \includegraphics[width=0.485\linewidth]{NRB3.eps}
}
\caption{\label{MWT-NRB} Boxplot of molecular weight and number of rotatable bonds of the 1000 ligands of each of the three molecular weight sets.}
\end{figure}
\end{center}
