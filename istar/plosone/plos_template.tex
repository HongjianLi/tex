...
Figure S1. The overall architecture of istar.

Figure S2. istar supports filtering ligands with molecular properties in a fine-grained manner and previewing the number of ligands to dock in real time.

Figure S3. istar supports monitoring job progress in real time.

Figure S4. istar writes verbose output to file in PDBQT format.

Figure S5. Redocking result of PDB ID 1B8N.

Figure S6. Redocking result of PDB ID 4TMN.

Figure S7. Redocking result of PDB ID 1PKX.

Figure S8. Redocking result of PDB ID 3HV8.
