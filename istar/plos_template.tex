...
idock encapsulates many more improvements. Please refer to its change log at https://github.com/HongjianLi/idock for a complete list of new features and bugfixes.
...
We executed idock x86\_64 v2.0 and AutoDock Vina x86 v1.1.2 on desktop computers with Intel Core i5-2400 CPU @ 3.10GHz and 4GB DDR3 RAM under Mac OS X 10.7.4 Build 11E53. Arguments to both programs were left as default. By default, both programs output at most 9 predicted conformations per ligand.
