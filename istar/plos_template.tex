...
idock encapsulates many more improvements, such as efficient multithreading by a lightweight thread pool, gzip/bzip2 support in both ligand input and output, automatic docking recovery from the previous stopping point, fast parsers for both receptor and ligand, and memory reallocation reduction via modern C++11 programming features. Please refer to its change log at https://github.com/HongjianLi/idock for a complete list of new features.
