...
Table \ref{ScoringFunctionComparison} compares 21 scoring functions on PDBbind v2007 core set ($N$ = 195). In terms of Pearson's correlation coefficient, RF-Score performs the best, while AutoDock Vina and idock rank 5th and 7th respectively, already outperforming the majority of commercial scoring functions.
