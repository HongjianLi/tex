...
\end{center}
\caption{
{\bf $RMSD$ of the predicted ligand conformation from the crystal one, showing the values for idock and AutoDock Vina. The color encodes the number of active rotatable bonds.} Very often the $RMSD$ of 2.0 \AA\ is regarded as the positive control for correct bound structure prediction.
}
...
\end{center}
\caption{
{\bf $RMSD$ of the predicted ligand conformation from the crystal one. Abscissa shows the number of active rotatable bonds.} Very often the $RMSD$ of 2.0 \AA\ is regarded as the positive control for correct bound structure prediction.
}
\label{NRB-RMSD}
\end{figure}
