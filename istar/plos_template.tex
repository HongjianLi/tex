...
%HTML5, node.js
%NoSQL, Does not use SQL as its query language, Schema-free, no join operation, Huge amount of data, High performance (1000x), Simple API, easy replication, Eventually consistent / BASE (not ACID)
%Document-oriented, High performance, High availability, Easy scalability, Rich query language
